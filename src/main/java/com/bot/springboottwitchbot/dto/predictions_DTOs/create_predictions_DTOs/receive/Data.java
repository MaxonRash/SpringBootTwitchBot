package com.bot.springboottwitchbot.dto.predictions_DTOs.create_predictions_DTOs.receive;
...
public class Data {
    ...
    public Data(String id, String broadcaster_id, String broadcaster_name, String broadcaster_login, String title, int winning_outcome_id, Outcomes outcomes, int prediction_window, String status, String created_at, String ended_at, String locked_at) {
        this.id = id;
