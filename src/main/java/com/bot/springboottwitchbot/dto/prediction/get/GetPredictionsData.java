...
public class GetPredictionsData {
    private String id;
    ...
    private ArrayList<GetPredictionsOutcome> outcomes;
    ...
    public ArrayList<GetPredictionsOutcome> getOutcomes() {
        return outcomes;
    }

    public void setOutcomes(ArrayList<GetPredictionsOutcome> outcomes) {
    ...
    public GetPredictionsData(String id, String broadcaster_id, String broadcaster_name, String broadcaster_login, String title, String winning_outcome_id, ArrayList<GetPredictionsOutcome> outcomes, int prediction_window, String status, String created_at, String ended_at, String locked_at) {
        this.id = id;
        this.broadcaster_id = broadcaster_id;
        this.broadcaster_name = broadcaster_name;
        this.broadcaster_login = broadcaster_login;
    ...
    public GetPredictionsData() {
    }

    @Override
    public String toString() {
        return "GetPredictionsData{" +
                "id='" + id + '\'' +
