...
public class EndPredictionResponseData {
    private String id;
    ...
    private EndPredictionResponseOutcome outcomes;
    ...
    public EndPredictionResponseData() {
    }

    public EndPredictionResponseData(String id, String broadcaster_id, String broadcaster_name, String broadcaster_login, String title, int winning_outcome_id, EndPredictionResponseOutcome outcomes, int prediction_window, String status, String created_at, String ended_at, String locked_at) {
        this.id = id;
    ...
    public EndPredictionResponseOutcome getOutcomes() {
        return outcomes;
    }

    public void setOutcomes(EndPredictionResponseOutcome outcomes) {
        this.outcomes = outcomes;
    }
