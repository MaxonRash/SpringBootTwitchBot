...
public class CreatePredictionResponseData {
    private String id;
    private String broadcaster_id;
    private String broadcaster_name;
    private String broadcaster_login;
    private String title;
    private int winning_outcome_id;
    private CreatePredictionResponseOutcome outcomes;
    ...
    public CreatePredictionResponseData() {
    }

    public CreatePredictionResponseData(String id, String broadcaster_id, String broadcaster_name, String broadcaster_login, String title, int winning_outcome_id, CreatePredictionResponseOutcome outcomes, int prediction_window, String status, String created_at, String ended_at, String locked_at) {
        this.id = id;
    ...
    public int getWinning_outcome_id() {
        return winning_outcome_id;
    }

    public void setWinning_outcome_id(int winning_outcome_id) {
        this.winning_outcome_id = winning_outcome_id;
    }

    public CreatePredictionResponseOutcome getOutcomes() {
        return outcomes;
    }

    public void setOutcomes(CreatePredictionResponseOutcome outcomes) {
        this.outcomes = outcomes;
    }
