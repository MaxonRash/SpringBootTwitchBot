...
public class EndPredictionResponseOutcome {
    private String id;
    ...
    public EndPredictionResponseOutcome() {
    }

    public EndPredictionResponseOutcome(String id, String title, int users, int channel_points, ArrayList<TopPredictors> top_predictors, String color) {
        this.id = id;
        this.title = title;
        this.users = users;
