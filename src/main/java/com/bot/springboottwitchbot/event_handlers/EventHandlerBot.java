...
//                if (UtilityCommandsHttpTest.getModeratorsList().contains(this.secondDuelName)) {
//                    twitchClientBot.getChat().sendMessage(event.getChannel().getName(), "@" + firstDuelName + " он же модир FailFish");
//                    UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName("happasc2"), 10, "no");
//                }
//                //TODO duel logic
//            }
//
...
//                twitchClientBot.getChat().sendMessage(eventChannel, "@" + firstDuelName + " вызывает " + "@" + secondDuelName + " на дуэль!");
...
//                    UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(secondNick), 10, "no");
//                }
//                else if (dice == 3) {
//                    twitchClientBot.getChat().sendMessage(event.getChannel().getName(), "@" + firstNick
...
//                    UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(deadRoulettePlayer), 10, "shodka");
//                }
//                else {
...
//                UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(firstNick), 10, "nick");
//            }
//            else if (dice == 2) {
//                twitchClientBot.getChat().sendMessage(event.getChannel().getName(), "@" + firstNick
...
//                UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(firstNick), 300, "Casino");
//            }
//
////            Global10secCDTimer.setGlobal10secTimer();
//        }
...
//                UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(firstNick), 10, "drops");
//            }
//            else if (dice == 2) {
//                twitchClientBot.getChat().sendMessage(event.getChannel().getName(), "@" + firstNick
...
//            }
//            else {
//                    UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(firstNick), Integer.parseInt(arrayList.get(3)), "muteAsked");
//            }
//            Global10secCDTimer.setGlobal10secTimer();
//        }
//
...
//            arrayList.remove("\udb40\udc00");
//
//            UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(arrayList.get(2)), 30, "sLoktya");
//        }
//    }
//
//    @EventSubscriber
...
//                UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(firstNick), 10, "kaban_i_gus");
//            }
//            else {
//                twitchClientBot.getChat().sendMessage(event.getChannel().getName(), "@" + firstNick
...
//            UtilityCommandsHttpTest.timeoutUserTest(UtilityCommandsGlobal.getUserIdByName(firstNick), 10, "polChataHren");
//        }
//
//
//    }
...
//
//    @EventSubscriber
//    public void timeouteUserTest(ChannelMessageEvent event) {
//        String newMessage = event.getMessage();
